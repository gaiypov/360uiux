...
exports.ApiVideoProvider = void 0;
...
class ApiVideoProvider {
    constructor() {
        if (!video_config_1.videoConfig.apiVideo.apiKey) {
            throw new Error('API_VIDEO_KEY is required for api.video provider');
        }
        this.client = new nodejs_client_1.default({
            apiKey: video_config_1.videoConfig.apiVideo.apiKey,
        });
    ...
    async uploadVideo(params) {
        try {
            ...
            const uploadResult = await this.client.videos.upload(videoCreation.videoId, tempFilePath);
...
exports.ApiVideoProvider = ApiVideoProvider;
//# sourceMappingURL=ApiVideoProvider.js.map