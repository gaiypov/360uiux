...
class SMSService {
    ...
    async sendVerificationCode(phone) {
        try {
            ...
            const recentCode = await database_1.db.oneOrNone(`SELECT * FROM sms_codes
         WHERE phone = $1
         ...
         LIMIT 1`, [phone]);
            ...
            // Сохраняем в базу
            await database_1.db.none(`INSERT INTO sms_codes (phone, code, expires_at)
         VALUES ($1, $2, $3)`, [phone, code, expiresAt]);
    ...
    async verifyCode(phone, code) {
        try {
            ...
            const smsCode = await database_1.db.oneOrNone(`SELECT * FROM sms_codes
         WHERE phone = $1
         AND verified = false
         ORDER BY created_at DESC
         LIMIT 1`, [phone]);
            ...
            if (smsCode.code !== code) {
                ...
                await database_1.db.none(`UPDATE sms_codes
           SET attempts = attempts + 1
           WHERE id = $1`, [smsCode.id]);
    ...
    async cleanupExpiredCodes() {
        try {
            await database_1.db.none(`DELETE FROM sms_codes
