...
function validateDatabaseConfig() {
    const { provider, yandex, vk, supabase, local: _local } = exports.databaseConfig;
    switch (provider) {
        case 'yandex':
        ...
        case 'local':
            ...
            break;
        default:
            throw new Error(`Unknown database provider: ${provider}. Must be 'yandex', 'vk', 'supabase', or 'local'`);
    }
